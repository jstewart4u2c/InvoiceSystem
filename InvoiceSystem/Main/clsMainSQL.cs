...
public class clsMainSQL
{
    ...
    public string InsertIntoInvoice()
    {
        ...
        int TotalCost = 0;
        string sSQL = "INSERT INTO Invoices(InvoiceDate,TotalCost) VALUES(" + ConvertDate + "," + TotalCost + ")";
        return sSQL;
    }
    ...
    /*SQL Statement for Grabbing Each Table??*/
    /*Figure Out The Correct Insert Statement for Adding To Invoices*/
